...
begin
    ...
    begin
		  ...
		  if rst_i = '1' then
				...
				int_up_5 <= (others=>(others=>(others=>'0')));
				int_up_4 <= (others=>(others=>(others=>'0')));
				int_up_m6 <= (others=>(others=>(others=>'0')));
				int_up_m11 <= (others=>(others=>(others=>'0')));
				int_up_m10 <= (others=>(others=>(others=>'0')));
				int_up_18 <= (others=>(others=>(others=>'0')));
				int_up_40 <= (others=>(others=>(others=>'0')));
				int_up_57 <= (others=>(others=>(others=>'0')));
